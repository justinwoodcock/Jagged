...
gulp.task('html', ['inject', 'partials'], function() {
    ...
    return gulp.src(paths.tmp + '/serve/*.html')
        ...
        .pipe($.replace('../assets/fonts/fontello/font', '../fonts'))
        .pipe($.csso())
...
gulp.task('fonts', function() {
    return gulp.src([
            paths.src + '/assets/fonts/**/*.{eot,svg,ttf,woff}',
            '../bower_components/bootstrap-sass-official/assets/fonts/bootstrap/*.{eot,svg,ttf,woff}'
        ])
        .pipe($.flatten())
